...
public void downloadExcel() throws IOException {
       ...
       try
       {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=lotes.xls"); // The Save As popup magic is done here. You can give it any file name you want, this only won't work in MSIE, it will use current request URL as file name instead.
        ...
        for (LoteDTO ldto: loteList){
             ...
             // s.addCell(new Label(1, i, ldto.getAlmacen()));
              ...
              //s.addCell(new Label(5, i, ldto.getSockActual().toString()));
